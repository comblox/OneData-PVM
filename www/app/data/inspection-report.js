...
(function() {
    ...
    angular
    .module('app')
    .factory('InspectionReportService', InspectionReportService);

    InspectionReportService.$inject = ['$http'];
    function InspectionReportService($http) {
        ...
        var json = $http.get('app/data/inspection-report.json').then(function(response) {
