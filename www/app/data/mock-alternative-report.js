/**
* @ngdoc Mock Backend
* @name MockAlternativeReportService
...
(function() {
    ...
    angular
    .module('app')
    .factory('MockAlternativeReportService', MockAlternativeReportService);

    MockAlternativeReportService.$inject = ['$http'];
    function MockAlternativeReportService($http) {
        ...
        var json = $http.get('app/data/alternative-report.json').then(function(response) {
